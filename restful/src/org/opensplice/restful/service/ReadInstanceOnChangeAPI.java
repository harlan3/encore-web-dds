...
public class ReadInstanceOnChangeAPI extends InstanceReaderResource {

   public ReadInstanceOnChangeAPI(Context context, Request request,
         Response response) {
   ...
   public Representation represent(Variant variant) throws ResourceException {
      ...
      if ((variant != null)
         ...
         String samples = getReader().readInstance(keyField, instanceID,
               DDS.LENGTH_UNLIMITED.value, NOT_READ_SAMPLE_STATE.value,
