...
public class TakeAPI extends ReaderResource {

   public TakeAPI(Context context, Request request, Response response) {
   ...
   public Representation represent(Variant variant) throws ResourceException {
      ...
      if ((variant != null)
         ...
         String samples = getReader().take(DDS.LENGTH_UNLIMITED.value,
