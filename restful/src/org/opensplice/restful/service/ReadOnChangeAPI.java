...
public class ReadOnChangeAPI extends ReaderResource {

   public ReadOnChangeAPI(Context context, Request request, Response response) {
   ...
   public Representation represent(Variant variant) throws ResourceException {
      ...
      if ((variant != null)
         ...
         String samples = getReader().read(DDS.LENGTH_UNLIMITED.value,
